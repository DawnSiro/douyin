...
type Client interface {
	...
	GetCommentList(ctx context.Context, req *comment.DouyinCommentListRequest, callOptions ...callopt.Option) (r *comment.DouyinCommentListResponse, err error)
}
...
func (p *kCommentServiceClient) GetCommentList(ctx context.Context, req *comment.DouyinCommentListRequest, callOptions ...callopt.Option) (r *comment.DouyinCommentListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
