...
type DouyinMessageChatRequest struct {
	...
	PreMsgTime *int64 `thrift:"pre_msg_time,3,optional" frugal:"3,optional,i64" json:"pre_msg_time,omitempty"`
}
...
func (p *DouyinMessageChatRequest) Field3DeepEqual(src *int64) bool {
	...
	if p.PreMsgTime == src {
		return true
	} else if p.PreMsgTime == nil || src == nil {
		return false
	}
	if *p.PreMsgTime != *src {
		return false
...
func (p *DouyinMessageChatResponse) SetStatusCode(val int64) {
	p.StatusCode = val
}
...
func (p *DouyinMessageChatResponse) Field1DeepEqual(src int64) bool {
...
func (p *DouyinMessageActionResponse) SetStatusCode(val int64) {
	p.StatusCode = val
}
...
func (p *DouyinMessageActionResponse) Field1DeepEqual(src int64) bool {
...
func (p *MessageServiceGetMessageChatArgs) SetReq(val *DouyinMessageChatRequest) {
	p.Req = val
}
...
func (p *MessageServiceGetMessageChatArgs) Field1DeepEqual(src *DouyinMessageChatRequest) bool {
...
func (p *MessageServiceGetMessageChatResult) Field0DeepEqual(src *DouyinMessageChatResponse) bool {
