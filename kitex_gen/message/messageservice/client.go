...
type Client interface {
	...
	GetMessageChat(ctx context.Context, req *message.DouyinMessageChatRequest, callOptions ...callopt.Option) (r *message.DouyinMessageChatResponse, err error)
}
...
func (p *kMessageServiceClient) GetMessageChat(ctx context.Context, req *message.DouyinMessageChatRequest, callOptions ...callopt.Option) (r *message.DouyinMessageChatResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
