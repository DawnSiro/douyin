...
type Client interface {
	...
	GetPublishVideos(ctx context.Context, req *publish.DouyinPublishListRequest, callOptions ...callopt.Option) (r *publish.DouyinPublishListResponse, err error)
}
...
func (p *kPublishServiceClient) GetPublishVideos(ctx context.Context, req *publish.DouyinPublishListRequest, callOptions ...callopt.Option) (r *publish.DouyinPublishListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
